...
def extract_options_data_from_image(image_path: str, debug: bool = False, engine: str = 'tesseract') -> List[Dict[str, str]]:
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        default='tesseract',
        help="Specify the OCR engine to use.\n"
             "tesseract: The default engine.\n"
             "easyocr: Alternative engine, may be more accurate.\n"
             "(default: tesseract)"
    )
    ...
    extracted_data = extract_options_data_from_image(args.image_file, debug=args.debug_mode, engine=args.engine)
